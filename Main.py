...
train, validation, test = load_data_from_csv(
    "Dataset/iris_data.csv", "Dataset/iris_data_val.csv", "Dataset/iris_data_test.csv")
...
print("Neural network accuracy:", model.validate(
    validation_X, validation_y)*100, "%")
